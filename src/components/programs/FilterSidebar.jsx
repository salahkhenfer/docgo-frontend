      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          >
            ...
            {organizations.map((org, index) => {
              const orgValue =
                typeof org === "object" ? org.organization || org.value : org;
              const orgLabel =
                typeof org === "object" ? org.organization || org.label : org;
              return (
                <option key={`org-${orgValue}-${index}`} value={orgValue}>
                  {orgLabel}
                </option>
              );
            })}
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-2 border border-gray-200 rounded-lg text-xs bg-white"
          >
            <option value="">{t("All Locations") || "All Locations"}</option>
        ...
        <div className="bg-cyan-50 p-3 rounded-lg border border-cyan-200">
          ...
          <div className="space-y-1">
            {[
              { value: "", label: t("All Formats") || "All Formats" },
              {
                value: "true",
                label: t("Online Programs") || "Online Programs",
              },
              {
                value: "false",
                label: t("On-site Programs") || "On-site Programs",
              },
            ].map((option) => (
              <label
                key={option.value}
