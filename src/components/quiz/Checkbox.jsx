...
function Checkbox({ isChecked, onChange }) {
    const iconMap = {
        false: "https://cdn.builder.io/api/v1/Image/assets/TEMP/d874d161a2429ff20972a278a17b63bf3016234a?placeholderIfAbsent=true&apiKey=ce15f09aba8c461ea95db36c370d18d3",
