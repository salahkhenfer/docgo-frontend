...
const CCPPayment = ({
    ...
    const validateForm = () => {
        ...
        const panelRules = [
            ...
            {
                field: "Transfer Reference",
                message: newErrors.transferReference,
                section: "Your Information",
                scrollToId: "transferReference",
                condition: !!newErrors.transferReference,
            },
            {
                field: "Phone Number",
                ...
                <div className="bg-white border-2 border-gray-200 rounded-lg p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                {t(
                                    "paymentPage.ccpPaymentForm.transferReference",
                                )}{" "}
                                <span className="text-red-500">*</span>
                            </label>
                            <input
                            ...
                            <p className="mt-1 text-xs text-gray-500">
                                {t(
                                    "paymentPage.ccpPaymentForm.transferReferenceHelp",
                                )}
                            </p>
                        </div>
