        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 rounded-lg p-5 shadow-sm">
                ...
                <div className="bg-white rounded-lg p-4 space-y-3 shadow-sm">
                    ...
                    <div className="flex justify-between items-center py-2 border-b">
                        <span className="text-gray-600 font-medium">{t("paymentPage.ccpPaymentForm.rib")}:</span>
                        <span className="font-mono font-medium text-gray-900">
                            {ccpAccountDetails.rib}
                        </span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b">
                        <span className="text-gray-600 font-medium">{t("paymentPage.ccpPaymentForm.bank")}:</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t("paymentPage.ccpPaymentForm.fullNamePlaceholder")}
                            />
                            {errors.fullName && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t("paymentPage.ccpPaymentForm.ccpNumberPlaceholder")}
                            />
                            {errors.ccpNumber && (
                                <p className="mt-1 text-sm text-red-600">
                                    {errors.ccpNumber}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t("paymentPage.ccpPaymentForm.transferReferencePlaceholder")}
                            />
                            {errors.transferReference && (
                                <p className="mt-1 text-sm text-red-600">
                                    {errors.transferReference}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder={t("paymentPage.ccpPaymentForm.phoneNumberPlaceholder")}
                            />
                            {errors.phoneNumber && (
                                <p className="mt-1 text-sm text-red-600">
                                    {errors.phoneNumber}
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <span>{t("paymentPage.ccpPaymentForm.submitForVerification")}</span>
                        </>
                    )}
                </button>
