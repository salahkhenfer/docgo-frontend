...
//     // Add click outside handler directly in this component
//     useEffect(() => {
...
//         setIsDropdownOpen(false);
//         // Call logout from AppContext if available
//         if (set_Auth) {
//             set_Auth(false);
//         }
//     };
...
//         //     {isDropdownOpen && (
//         //         <div
//         //             className="fixed right-[20px] top-[70px] w-56 bg-white rounded-lg shadow-xl py-2
//         //             z-[9999] transform transition-all duration-200 origin-top-right"
//         //             style={{
