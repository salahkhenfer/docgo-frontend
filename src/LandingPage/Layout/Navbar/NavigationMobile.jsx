...
// function NavigationMobile({ CustomAvatar }) {
//     const { t } = useTranslation();
//     const [isOpen, setIsOpen] = useState(false);
...
//                     {/* Render CustomAvatar for mobile */}
//                     {!user ? (
//                         <CustomAvatar
...
//             {isOpen && (
//                 <div className="bg-white shadow-md py-4 px-6 absolute w-full z-50">
...
//                             offset={-100}
//                             duration={500}
//                             className="text-customGray py-2"
//                             onClick={() => setIsOpen(false)}
//                         >
//                             {t("AboutUsLink")}
//                         </ScrollSmooth>
