...
function AboutUsSection({ cms }) {
    ...
    const flags = [
        { url: FranceFlag, name: t("France", "France") },
        { url: CanadaFlag, name: t("Canada", "Canada") },
        { url: EnglandFlag, name: t("England", "England") },
        { url: GermanyFlag, name: t("Germany", "Germany") },
        { url: BelgiumFlag, name: t("Belgium", "Belgium") },
        { url: UnitedStatesFlag, name: t("UnitedStates", "United States") },
    ];
                ...
                <div className="backdrop-blur-sm bg-[#F7FCFF]/20 rounded-lg shadow-lg p-6 sm:p-8 md:p-12 lg:p-16">
                    <div className="max-w-4xl mx-auto flex flex-col gap-6 md:gap-8 lg:gap-10">
                        <h1 className="sm:text-2xl lg:text-2xl xl:text-3xl font-medium text-customGray text-center">
                            {c("aboutTitle") || t("AboutUs", "About Us")}
                        </h1>

                        <p className="sm-sm:text-[12px] sm:text-sm lg:text-base xl:text-lg text-customGray leading-relaxed text-center">
                            {c("aboutDescription") || t("AboutUsDescription", "We empower students to access study abroad opportunities and professional growth. We offer personalized guidance, online courses, and a supportive community to help you achieve your academic and professional goals. Unlock your potential with us!")}
                        </p>
                        ...
                        >
                            <p className="sm-sm:text-sm text-base sm:text-base md:text-lg lg:text-lg xl:text-xl text-customGray font-medium">
                                {t("StudyAbroadQuote", "\"Studying abroad can change the way you see the world\"")}
                            </p>
                        </div>
                    </div>
                </div>
