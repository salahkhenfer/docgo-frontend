      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        {submitted ? (
          ...
          <div className="text-center space-y-4">
            ...
            <h2 className="text-xl font-bold text-gray-900">Demande reçue</h2>
            ...
            <div className="rounded-lg bg-blue-50 border border-blue-100 p-4 text-left">
              <p className="text-xs text-blue-700 leading-relaxed">
                <strong>Note :</strong> Ce processus est manuel. L&apos;équipe
                healthpathglobal examinera votre demande et vous enverra vos
                identifiants par e-mail dans les meilleurs délais.
              </p>
            </div>
            <Link
              to="/Login"
          ...
          <>
            ...
            <p className="text-sm text-gray-500 mb-6 text-center">
              Entrez votre e-mail et un administrateur vous contactera.
            </p>
