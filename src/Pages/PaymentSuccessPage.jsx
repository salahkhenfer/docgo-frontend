        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="mb-6">
            {isPayPal && (
              <p className="text-gray-600">
                Your PayPal payment has been processed successfully. You now
              ...
              <div className="space-y-2">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <p className="text-sm text-yellow-800">
                    <strong>Important:</strong> We will verify your payment
                    within 24 hours. You will receive an email confirmation once
                    verified.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <h3 className="font-medium text-gray-900 mb-2">
              {itemType === "course" ? "Course Enrolled" : "Program Applied"}
            </h3>
