      ...
      <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-6">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 truncate">
                {t("programStatus.title", "Program Application Status")}
              </h1>
            ...
            <p className="text-gray-700 mt-2 truncate">
              {title || t("programStatus.unknownProgram", "Program")}
            </p>
            <div className="text-sm text-gray-500 mt-1">
              {t("programStatus.programId", "Program ID")}: {programIdStr}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              {t("programStatus.messageSupport", "Message Support")}
            </button>
          </div>
        </div>
      </div>
      ...
      {!application && !enrollment ? (
        <div className="bg-white rounded-lg shadow-sm p-10 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            >
              {t("programStatus.browsePrograms", "Browse Programs")}
            </Link>
            <Link
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <div className="text-xs uppercase text-gray-500">
                  {t("programStatus.enrollDate", "Enroll Date")}
                </div>
                <div className="mt-1 font-medium text-gray-900">
                  {formatDateTime(
              ...
              <div>
                <div className="text-xs uppercase text-gray-500">
                  {t("programStatus.organization", "Organization")}
                </div>
                <div className="mt-1 font-medium text-gray-900">
            ...
            <div className="mt-6">
              <h3 className="text-sm font-bold text-gray-900 mb-2">
                {t("programStatus.communication", "Communication")}
              </h3>
          ...
          <div className="flex flex-col gap-4 sm:gap-6">
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  {t("programStatus.allApplications", "All Applications")}
                </Link>
                <Link
                  to="/dashboard/messages"
            ...
            {(() => {
              ...
              return (
                <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                  <h2 className="text-lg font-bold text-gray-900 mb-4">
                    {t("programStatus.contactUs", "Contact Us")}
                  </h2>
                  {!hasContactData ? (
                    <div className="text-sm text-gray-500 space-y-2">
                      <p>
                        {t(
                          "programStatus.contactViaMessages",
                          "Have a question? Send us a message and our team will get back to you.",
                        )}
                      </p>
                      <Link
                        to="/dashboard/messages"
                        className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-[#0086C9] text-white rounded-lg text-sm hover:bg-[#006fa8] transition-colors"
                      >
                    ...
                    <>
                      <div className="space-y-3 text-sm text-gray-600">
                        {contactInfo.email && (
                          ...
                          >
                            <Mail className="w-4 h-4 flex-shrink-0 text-[#0086C9]" />
                        ...
                        {contactInfo.phone && (
                          <a
                            ...
                            className="flex items-center gap-2 hover:text-gray-900"
                          >
                            <Phone className="w-4 h-4 flex-shrink-0 text-[#0086C9]" />
                            <span>{contactInfo.phone}</span>
                          </a>
                        )}
                        {contactInfo.address && (
                          <div className="flex items-start gap-2">
                            <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5 text-[#0086C9]" />
