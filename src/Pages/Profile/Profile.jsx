...
const Profile = () => {
    ...
    const transformedCourses =
        profileData.enrollments?.courses?.map((enrollment) => ({
            ...
            isCompleted:
                enrollment.IsCompleted || enrollment.status === "completed",
            status:
                enrollment.status ||
    ...
    const transformedApplications = [
        ...
        ...(profileData.applications?.courses?.map((app) => ({
            id: app.id,
            program:
                app.Course?.Title || app.Course?.Title_ar || "Unknown Course",
