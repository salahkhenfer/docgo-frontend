...
export function SearchProgram() {
    ...
    const fetchPrograms = useCallback(
        async (page = 1, forceRefresh = false) => {
            try {
                setLoading(page === 1 || forceRefresh);
                setSearchLoading(page > 1 && !forceRefresh);
                ...
                if (hasSearch || hasFilters) {
                    ...
                    response = await clientProgramsAPI.searchPrograms(
                        searchParams
                    );
                } else {
    ...
    const handleProgramClick = (programId) => {
        navigate(`/searchprogram/${programId}`);
    };
                        ...
                        {error ? (
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
                                ...
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    {t("NoProgramFound") || "No programs found"}
                                </h3>
